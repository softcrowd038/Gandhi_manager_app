...
class TermsAndConditionService {
  ...
  Future<TermsAndConditionModel?> getAllTermsAndConditions(
    BuildContext context,
  ) async {
    try {
      final dio = await getDioInstance();
      final response = await dio.get('terms-conditions');
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Failed to load T&C')));
        return null;
      }
    } catch (e) {
