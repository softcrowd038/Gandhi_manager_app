...
class FetchQuotationsByMonth {
  ...
  Future<QuotationsByMonth> fetchQuotationsByMonth(BuildContext context) async {
    try {
      final dio = await getDioInstance();
      final response = await dio.get('quotations/count/month');
